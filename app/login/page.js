...
const page = () => {
    ...
    return (
        <div >
            {/* <div>hello main this is login page</div> */}
            <div className='text-white container mx-auto pt-32 md:pt-20 '>
                <h1 className='text-center font-semibold text-3xl'>Login to Get Started</h1>
            </div>
            <div className="flex flex-col gap-2 min-h-[70.3vh] justify-center items-center pb-[20vh] md:pb-10 p-10">
